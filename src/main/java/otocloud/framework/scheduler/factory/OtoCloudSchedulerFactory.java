...
public class OtoCloudSchedulerFactory implements SchedulerFactory {

	private List<String> jobList;
	private Map<Scheduler, OtoCloudCascadingClassLoadHelper> classLoadHelpers;
    /*
     * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
     *
     * Constants.
...
/*    public List<String> getJobList() {
	...
	public Map<Scheduler, OtoCloudCascadingClassLoadHelper> getClassLoadHelpers() {
		return classLoadHelpers;
	}
     ...
     */
    public OtoCloudSchedulerFactory(List<String> jobList) {
    	this.jobList = jobList;
    	Map<Scheduler, OtoCloudCascadingClassLoadHelper> temp = new HashMap<Scheduler, OtoCloudCascadingClassLoadHelper>();
		classLoadHelpers = Collections.synchronizedMap(temp);    	
    }
     ...
     */
    public OtoCloudSchedulerFactory(Properties props, List<String> jobList) throws SchedulerException {
    	this(jobList);
        initialize(props);
    }
     ...
     */
    public OtoCloudSchedulerFactory(String fileName, List<String> jobList) throws SchedulerException {
    	this(jobList);
    	initialize(fileName);
    }
...
/*        classLoadHelperClass = cfg.getStringProperty(
        ...
        OtoCloudCascadingClassLoadHelper loadHelper = new OtoCloudCascadingClassLoadHelper(jobList);
...
/*        try {
        ...
        if (jmxProxy) {
            ...
            classLoadHelpers.put(jmxScheduler, loadHelper);
        ...
        try {
            ...
            classLoadHelpers.put(scheduler, loadHelper);
...
/*    private Class<?> loadClass(String className) throws ClassNotFoundException, SchedulerConfigException {
     ...
     * @see #initialize()
     */
    public static Scheduler getDefaultScheduler(List<String> jobList) throws SchedulerException {
    	OtoCloudSchedulerFactory fact = new OtoCloudSchedulerFactory(jobList);
    ...
    private void setDetails(Object target, String schedulerName,
            String schedulerId) throws SchedulerException {
    	detailsSet(target, "setInstanceName", schedulerName);
    	detailsSet(target, "setInstanceId", schedulerId);
    }

    private void detailsSet(Object target, String method, String value)
            throws SchedulerException {
        final Method setter;
        ...
        try {
        	...
        	log.error("A SecurityException occured: " + e.getMessage(), e);
            return;
